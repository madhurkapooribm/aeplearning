...
In the above screenshot, you can see that our descriptor is located in ```_ibmnaamericaspartnersandbox.identification.emailId```, which is set as the Primary Identifier, linked to the namespace of "email".
