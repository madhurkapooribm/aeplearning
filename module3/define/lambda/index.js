...
function sendExperienceEvent(selectedProduct, interaction) {
  ...
  experienceEventJson.body.xdmEntity._ibmnaamericaspartnersandbox.productData.productUrl = productImage1.url();
  experienceEventJson.body.xdmEntity._ibmnaamericaspartnersandbox.productData.productName = selectedProduct.get("name");
  experienceEventJson.body.xdmEntity._ibmnaamericaspartnersandbox.productData.productInteraction = interaction;
  experienceEventJson.body.xdmEntity._ibmnaamericaspartnersandbox.identification.emailId = emailAddress;
